# dalang - worked example of a run's artifacts

> **NOT A REAL RUN. NOT COUNTED.** This file is a *dry-run-zero*: a synthetic,
> illustrative example of what dalang's three artifact tables look like when
...
> written, no tests were run. The Punakawan panel that produced RECIPE.md was
...
| 1 | Security (shift-left) | `/punakawan:panel --preset safeguard` | threat model: spoofable client IP, counter-map DoS -> folded into plan |
...
| 5 | Commit / Release | **hard human GATE** + worktree sandbox | *stops here - dalang never auto-commits* |
