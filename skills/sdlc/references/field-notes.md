# dalang field notes — load-bearing evidence behind the SKILL.md rules
...
- **Loop-back fix is a fork / Code review is a STAGE / Verify findings:** a backend SEO slice's
  ...
  never planned to touch** and carried design forks → each went to a Punakawan gate before any
