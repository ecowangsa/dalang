# dalang promotion history

This document preserves the gating discipline that governed dalang during its
...
## Status of dalang during the recipe phase (verbatim from former RECIPE.md)

dalang lived as a recipe (a documented flow described in a markdown file, with
...
> **Promotion trigger.** Promotion of this recipe into a thin `dalang` conductor
...
>   recipe's original author needs `dalang` as an invokable skill rather than as
...
> existed. After two counted runs, a subsequent Punakawan deliberation (with the
...
## Punakawan deliberation 2026-05-29 - revising (e)

A second Punakawan was convened to deliberate the form of the first consumer
...
3. Bagong's dissent that the gatekeeper convening the panel was itself
...
- The promotion gating in (e) was a process-anxiety hedge added at a prior
  Punakawan deliberation, not a substantive constraint on dalang's usefulness.
- Punakawan itself was created without (e) as a gate. The asymmetry was
...
- The gatekeeper had a concrete current task (tech debt at the Valkyrie
  ...
  dalang would accelerate their work as a skill rather than a recipe.

Accordingly, (e) was revised on 2026-05-29 to the following text (Option 1
from the deliberation, chosen by the gatekeeper):

> (e) **A consumer with real need exists** - dalang is invoked because someone
...
> Punakawan deliberation 2026-05-29 found strict identity-based reading too
...
Combined with (a)-(d) already MET, dalang was promoted to skill form on
2026-05-29.

## Bagong dissent (reported in full per Punakawan protocol)

Bagong (Contrarian lens) argued at Round 1 that the entire promotion question
...
> else (or some system) has already tried to use dalang, hit friction, and
...
At Round 2, Bagong refined the dissent:
...
> telegraphed wanting. That is correlated error, not consensus. Kresna's
...
The gatekeeper acknowledged Bagong's Round-2 prediction was substantially
...
explicitly rather than silently treat it as cleared, addressing Bagong's
...
Bagong's dissent stands on record. Future readers asking "should we re-tighten
...
| Date | Event |
| --- | --- |
| 2026-05-26 | dalang created as recipe (RECIPE.md), original (a)-(e) gating. |
...
| 2026-05-29 | First Punakawan deliberation about (e) form. Second sub-deliberation revised (e) per Option 1. Gatekeeper promoted dalang to skill: RECIPE.md split into SKILL.md (operational) + references/promotion-history.md (this file). |
